...
//
//    public AlbumsSpinner2(@NonNull Context context) {
////        spinner = new AppCompatSpinner(context, null, R.attr.listPopupWindowStyle);
...
////        mListPopupWindow.setHorizontalOffset((int) (5 * density));
...
////                AlbumsSpinner2.this.onItemSelected(parent.getContext(), position);
